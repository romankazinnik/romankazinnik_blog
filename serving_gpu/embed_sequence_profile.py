...
if __name__ == "__main__":
    ...
    print(f"\n num_requests={num_requests} batch_size={batch_size} debug={EmbeddingsInference.debug} profile_mode={profile_mode}")
    ...
    print(f" Disk I/O latency={1000*disk_io_time/batch_size:.1f}ms/image")
    print(f" CPU processing latency={1000*cpu_time/batch_size:.1f}ms/image")
    ...
    print(f" GPU transfer latency={1000*gpu_transfer_time/batch_size:.1f}ms/image")
